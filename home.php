...
get_header();
$pageID = get_the_ID();?>
<section class="hero main-header-hero-home">
    <div class="heroMain">
        ...
        <div class="heroContent">
            <div class="container">
                <div class="contentHere">
                    <h1 style="color:<?php the_field('heading_color', get_the_ID());?>;"><?php the_field('quote_section_heading', $pageID);?></h1>
                    <h3 style="color:<?php the_field('sub_heading_color', get_the_ID());?>;"><?php the_field('quote_section_sub_heading', $pageID);?></h3>
                    ...
                    <div class="phone">
                        <p><img class="ph-img" src="<?php echo get_template_directory_uri(). '/img/white.png';?>" srcset="http://fencesdev.ezhome.io/wp-content/uploads/2018/01/white@2x.png 2x, http://fencesdev.ezhome.io/wp-content/uploads/2018/01/white@3x.png 3x"/><a href="tel:<?php the_field('quote_section_number', $pageID);?>"><?php the_field('quote_section_number', $pageID);?></a></p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="trustedWood">
    <div class="container">
        <div class="mainHeading col-sm-12">
            <h3><?php the_field('fences_heading' , get_the_ID());?></h3>
            <p><?php the_field('fences_sub_heading' , get_the_ID());?></p>
        </div>
        <?php
        $args = array(
              ...
              if ( $woodfence->have_posts() ) {
                  ...
                  <div class="col-sm-4">
                      <div class="singleBox">
                          ...
                          <h4><?php the_title();?></h4>
                          <p><?php the_excerpt();?></p>
						  <p class="Fence-diagram"><a target="_blank" href="<?php the_field('fence_diagram_links', get_the_ID());?>">Fence diagram</a></p>
                      </div>
                  </div>
              	<?php }
              ...
              $count = 1;
                ...
                // display a sub field value ?>
                    <div class="singleContent">
						...
						<?php if(!empty( the_sub_field('installation_list_item_1', $pageID))){?>
                        <div class="singleDes">
                            <div class="checkmark"></div>
                            <p><?php the_sub_field('installation_list_item_1', $pageID);?></p>
                        </div>
						<?php }
						if(!empty( the_sub_field('installation_list_item_1', $pageID))) {?>
                        <div class="singleDes">
                            <div class="checkmark"></div>
...
<section class="QA">
  ...
  ?>
    <div class="read-m">
      <p class="Read-more text-right"><a href="<?php echo get_home_url();?>/help/">Read more →</a></p>
    </div>
    </div>
</section>
        ...
        <div class="fenceContent">
            <div class="container">
                <div class="fenceContentHere">
                    <h3><?php the_field('cta_title', get_the_ID());?></h3>
                    <p><?php the_field('sub_heading', get_the_ID());?></p>
                    <div class="form-group" data-address-input>
                        <input id="textinput" name="textinput" type="text" placeholder="Enter your street address" class="form-control input-md">
                        <button class="btn btn-default quote">Get a quote</button>
                    </div>
...
<section class="reviews">
    <div class="container">
        <div class="heading col-sm-12">
            ...
            <h3><?php the_field('testimonial_title', get_the_ID());?></h3>
        </div>
      ...
      ?>
        <div class="more col-sm-12">
            <a href="<?php echo get_home_url();?>/reviews"><h4>More reviews →</h4></a>
        </div>
    </div>
</section>
<?php get_footer(); ?>
